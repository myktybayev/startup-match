...
public class InvestorsFragment extends Fragment {
    ...
    /**
     * Мысал деректер: алдымен Figma InvestorsPage2 (node 91:1317), соңынан бұрынғы экрандағы 5 инвестор.
     * Аватарлар: {@code figma_investors_page2_1..5.jpg}, {@code figma_investor_avatar_1..5.jpg}.
     */
